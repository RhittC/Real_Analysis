...
And perhaps most importantly, you can make your \textit{own} definitions and formulations as you see fit.
...
More specifically, the mathematician prescribes a list of objective and reasonable rules for how logic operates, independent of whatever content (in our case, maths) you choose to discuss with it, and hands it over for the philosopher to contest.
...
but they have so much confidence in those foundational logical rules themselves that they never doubt them again.
...
\begin{result}{Definition}{G}{The Gold Standard of Proof}{green}
    ...
    To distinguish, we sometimes say $P$ is ``definitively true'' \textit{if and only if} we can show that:
