...
Nonetheless, mathematicians collectively agree on a handful of axioms called $ZF$ (all of which we will encounter in the next 2 chapters) as the basis for our gold standard of proof, 
...
\begin{result}{Definition}{D}{The Gold Standard of Proof}{green}
    A conjecture $P$ is considered ``proven'' \textit{if and only if} we can show the following with our logic:
    $ZF \implies P$
